      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-3xl mx-auto">
            {BRAND_PROMISE} Formulaire simple, WhatsApp direct et reseaux
            sociaux pour vous repondre rapidement.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section className="bg-gray-900 border border-gray-800 rounded-3xl p-6">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white font-bold py-4 rounded-xl transition-colors text-sm sm:text-base break-all"
            >
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 rounded-lg bg-gray-800 text-gray-200 hover:bg-red-500 hover:text-white transition-colors text-center flex-1 min-w-[120px]"
                >
                  Facebook
                </a>
                <a
            ...
            <div className="mt-8 border-t border-gray-800 pt-5 text-gray-400 text-sm space-y-2">
              ...
              <p className="break-all">Email: contact@bykmtvtion-fitmarket.com</p>
